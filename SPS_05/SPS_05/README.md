...
Берляндия состоит из n городов. Изначально все города изолированы, то есть между городами нет дорог.
...
На каждый запрос выведите одно число — количество компонент связности в графе из городов после добавления очередной дороги.
